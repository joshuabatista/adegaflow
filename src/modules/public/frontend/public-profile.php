                        ...
                        <div class="flex justify-center">
                            <div class="bg-[#2b2d3e] pl-8 pr-8 pt-8 pb-4 rounded-2xl shadow-2xl">
                                ...
                                <div class="flex justify-center mt-4">
                                    <button type="button" class="btn btn-editar-adega justify-center items-center gap-2 inline-flex">
                                        Salvar informações
                                        <svg aria-hidden="true" role="status" class=" w-4 h-4 me-3 text-white animate-spin loading-editar hidden" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
