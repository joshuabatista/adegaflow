<div class="pr-0 sm:pr-4">
    <div class="hidden md:grid grid-cols-6 p-3 mt-2 gap-2.5">
        ...
        <div class="">
            ...
            <input class="form-input" id="data_entrada_de" type="date" placeholder="01/01/2025">
        </div>
        ...
        <div class="">
            ...
            <input class="form-input" id="data_entrada_ate" type="date" placeholder="Quantidade">
        </div>
        ...
        <div class=" col-span-2">
            ...
            <select name="plano_contas" id="plano_contas_filtro" class="form-input">
            </select>
        </div>
    </div>
