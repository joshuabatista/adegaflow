<div class="bg-[#2b2d3e] p-4 rounded shadow-2xl">
    ...
    <div class="grid grid-cols-2 mt-4 gap-2">
        <div class="col-span-1">
            ...
            <input type="text" name="valor" id="valor" class="form-input" readonly disabled>
        </div>
        <div class="col-span-1">
    ...
    <div class="flex mt-4  justify-center text-center items-center">
        <button class="btn w-full btn-add-carrinho"><i class="fa-solid fa-cart-shopping"></i> Adicionar ao carrinho</button>
    </div>

   <div id="carrinhoLista" class="carrinho"></div>
    ...
    <div class="flex mt-4  justify-center">
        <button class="btn-success w-full btn-vender inline-flex gap-2 items-center justify-center">
            <i class="fa-solid fa-hand-holding-dollar"></i> Finalizar venda
             <svg aria-hidden="true" role="status" class=" w-4 h-4 me-3 text-white animate-spin loading-new-sale hidden " viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
